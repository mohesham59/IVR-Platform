...
class CleanFallbackGreetingTest {
    ...
    void testBothPassesFailingProducesCleanGreetingWithoutCorruptedHeadersOrLeakedKeys() {
        ...
        // Execute flow generation with prompt history
        Flow flow = unifiedAiEngine.generateFlow(tenantId, sessionId, userPrompt, "groq", "llama-3.3-70b-versatile", 0.7, 30, List.of(historyMsg));
    ...
    void testDetectedDomainPropagatesToTemplateGeneratorFallback() {
        ...
        Flow flow = unifiedAiEngine.generateFlow(tenantId, sessionId, userPrompt, "groq", "llama-3.3-70b-versatile", 0.7, 30, List.of());
