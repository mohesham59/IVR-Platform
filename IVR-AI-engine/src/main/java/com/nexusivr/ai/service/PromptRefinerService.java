...
public class PromptRefinerService {
    ...
    private static final String REFINER_SYSTEM_INSTRUCTION = """
        ...
        CRITICAL RULES:
        - Infer the business domain from context (e.g., restaurant, banking, healthcare, telecom, insurance, retail, education, hospitality, government, airline, technical_support, generic).
        - Do NOT use a fixed list of domains — infer whatever domain fits the user's description.
