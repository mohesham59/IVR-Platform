...
public class ErrorResponse {
    ...
    public ErrorResponse() {
        ...
        this.providerAttempts = new java.util.ArrayList<>();
    }
    ...
    public void setProviderAttempts(List<ProviderAttemptDto> providerAttempts) { this.providerAttempts = providerAttempts != null ? providerAttempts : new java.util.ArrayList<>(); }
